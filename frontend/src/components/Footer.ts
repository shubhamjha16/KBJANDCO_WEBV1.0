    ...
    render(): HTMLElement {
        ...
        footer.innerHTML = `
            ...
            <div class="floating-actions">
                <a href="https://wa.me/918826456565?text=Hello%20!" class="float-btn whatsapp" aria-label="WhatsApp">
                    <span>💬</span>
                </a>
                <a href="tel:+91-8826456565" class="float-btn phone" aria-label="Call">
                    <span>📞</span>
                </a>
            </div>
        `;
